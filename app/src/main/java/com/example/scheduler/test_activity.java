...
public class test_activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(test_activity.this, searchBar.class);
            ...
            public void onClick(View v) {
                ...
                db.child(firebaseAcctId).updateChildren(thestuff).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(test_activity.this, "Schedule added", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        e.printStackTrace();
                        Toast.makeText(test_activity.this, "Adding Unsuccessful", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public void deselection(RadioButton theButton) {
        ...
        if (!theButton.isSelected()) {
            ...
            Toast.makeText(test_activity.this, day + time + " Deleted! ", Toast.LENGTH_SHORT).show();
        }
    }
